...
function opengrapher_display_page() { ?>
  <div class="wrap">
    ...
    <form method="post" action="options.php" class="opengrapher-options">
      ...
      <p>For more information, please <a href="https://developers.google.com/youtube/youtube_subscribe_button">see the official YouTube button page</a>.</p>
      <!--p>
        <label for="opengrapher_display_youtube_subscribe_disable">Disable</label>
        <input type="checkbox" <?php checked(get_option('opengrapher_display_youtube_subscribe_disable', true) == 'on') ?> name="opengrapher_display_youtube_subscribe_disable" />
      </p-->
      <p>
        <label for="opengrapher_display_youtube_channel">Channel</label>
        <input type="text" value="<?php echo get_option("opengrapher_display_youtube_channel") ?>" name="opengrapher_display_youtube_channel" />
      </p>
      <!--p>
        <label for="opengrapher_display_youtube_subscribe_count">Show Count</label>
        <input type="checkbox" value="true" <?php checked(get_option('opengrapher_display_youtube_subscribe_count',true) == 'true') ?> name="opengrapher_display_youtube_subscribe_count" />
      </p>
      <p>
        <label for="opengrapher_display_youtube_subscribe_size">Layout</label>
        <select name="opengrapher_display_youtube_subscribe_size">
          <option value="medium" <?php selected(get_option("opengrapher_display_youtube_subscribe_size")=='medium') ?>>Medium</option>
          <option value="small" <?php selected(get_option("opengrapher_display_youtube_subscribe_size")=='small') ?>>Small</option>
          <option value="standard" <?php selected(get_option("opengrapher_display_youtube_subscribe_size")=='standard') ?>>Standard</option>
          <option value="tall" <?php selected(get_option("opengrapher_display_youtube_subscribe_size")=='tall') ?>>Tall</option>
        </select>
      </p-->
