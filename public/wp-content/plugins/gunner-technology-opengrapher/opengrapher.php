...
function opengrapher_get_fbml($content="") {
  ...
  $youtube_channel = get_option("opengrapher_display_youtube_channel");
  if(isset($youtube_channel) && $youtube_channel) {
    $opengrapher_ret .= '<li class="'.get_option('opengrapher_display_css_youtube_class','youtube-button').'">';
    $opengrapher_ret .= '<script src="https://apis.google.com/js/plusone.js"></script>';
    $opengrapher_ret .= '<div class="g-ytsubscribe" data-channel="'.$youtube_channel.'" data-layout="default"></div>';
    $opengrapher_ret .= '</li>';
  }
