...
if ($logo_topmargin) {
	echo '.logo { top: '.$logo_topmargin.'px; }';
}
$logo_leftmargin=of_get_option('logo_leftmargin');
if ($logo_leftmargin) {
	echo '.logo { left: '.$logo_leftmargin.'px; }';
}
...
if ($step_1_icon) {
	echo '.grid-list-services .service-icon1 { background-image: url('.$step_1_icon.'); }';
}
$step_2_icon=of_get_option('step_2_icon');
if ($step_2_icon) {
	echo '.grid-list-services .service-icon2 { background-image: url('.$step_2_icon.'); }';
}
$step_3_icon=of_get_option('step_3_icon');
if ($step_3_icon) {
	echo '.grid-list-services .service-icon3 { background-image: url('.$step_3_icon.'); }';
}
$step_4_icon=of_get_option('step_4_icon');
if ($step_4_icon) {
	echo '.grid-list-services .service-icon4 { background-image: url('.$step_4_icon.'); }';
}
//icon Backgrounds
$stepicon_1_bgcolor=of_get_option('stepicon_1_bgcolor');
if ($stepicon_1_bgcolor) {
	echo '.grid-list-services .service-icon1 { background-color:'.$stepicon_1_bgcolor.'; }';
}
$stepicon_2_bgcolor=of_get_option('stepicon_2_bgcolor');
if ($stepicon_2_bgcolor) {
	echo '.grid-list-services .service-icon2 { background-color:'.$stepicon_2_bgcolor.'; }';
}
$stepicon_3_bgcolor=of_get_option('stepicon_3_bgcolor');
if ($stepicon_3_bgcolor) {
	echo '.grid-list-services .service-icon3 { background-color:'.$stepicon_3_bgcolor.'; }';
}
$stepicon_4_bgcolor=of_get_option('stepicon_4_bgcolor');
if ($stepicon_4_bgcolor) {
	echo '.grid-list-services .service-icon4 { background-color:'.$stepicon_4_bgcolor.'; }';
}

//Step Backgrounds
$step_1_bgcolor=of_get_option('step_1_bgcolor');
if ($step_1_bgcolor) {
	echo '.grid-list-services ul li .gridservice_col1 { background-color:'.$step_1_bgcolor.'; }';
}
$step_2_bgcolor=of_get_option('step_2_bgcolor');
if ($step_2_bgcolor) {
	echo '.grid-list-services ul li .gridservice_col2 { background-color:'.$step_2_bgcolor.'; }';
}
$step_3_bgcolor=of_get_option('step_3_bgcolor');
if ($step_3_bgcolor) {
	echo '.grid-list-services ul li .gridservice_col3 { background-color:'.$step_3_bgcolor.'; }';
}
$step_4_bgcolor=of_get_option('step_4_bgcolor');
if ($step_4_bgcolor) {
	echo '.grid-list-services ul li .gridservice_col4 { background-color:'.$step_4_bgcolor.'; }';
}
...
$pagetop_bar=of_get_option('pagetop_bar');
if ($pagetop_bar) {
echo '.top-menu-wrap{ border-top-color:'.$pagetop_bar.'; }';
}

$slideshow_controlbg=of_get_option('slideshow_controlbg');
if ($slideshow_controlbg) {
echo '.control-underlay{ background:'.$slideshow_controlbg.'; }';
}

$slideshow_captionbg=of_get_option('slideshow_captionbg');
if ($slideshow_controlbg) {
echo '#slidecaption{ background:'.$slideshow_captionbg.'; }';
}

$slideshow_titletext=of_get_option('slideshow_titletext');
if ($slideshow_titletext) {
echo '.slideshow_title{ color:'.$slideshow_titletext.'; }';
}

$slideshow_desctext=of_get_option('slideshow_desctext');
if ($slideshow_desctext) {
echo '.slideshow_caption{ color:'.$slideshow_desctext.'; }';
}

$fullscreen_toggle_color=of_get_option('fullscreen_toggle_color');
if ($fullscreen_toggle_color) {
echo '.menu-toggle{ background-color:'.$fullscreen_toggle_color.'; }';
}
...
$sidebar_background=of_get_option('sidebar_background');
if ($sidebar_background) {
echo '.sidebar-wrap, .sidebar-wrap-single { background:'.$sidebar_background.'; }';
}
