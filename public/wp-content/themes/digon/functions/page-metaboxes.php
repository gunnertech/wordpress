...
$meta_box = array(
	'id' => 'my-meta-box',
	'title' => MTHEME_NAME . ' Portfolio Metabox',
	'page' => 'page',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array(
			...
			'options' => array('4 Column','3 Column', '2 Column', '1 Column','Filterable Portfolio' )
		),
		array(
		...
		switch ($field['type']) {
			...
			case 'select':
				if (isset($field['target'])) {
					$field['options'] = get_select_target_options($field['target']);
				}
				if (isset($field['target'])) {
					echo '<select name="', $field['id'], '" id="', $field['id'], '">';
