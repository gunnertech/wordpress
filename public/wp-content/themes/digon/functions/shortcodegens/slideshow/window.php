...
<form name="mtheme_type" action="#">
	<!-- style_panel -->
	<fieldset>
		<legend>Enable Lightbox</legend>
		<select id="sc_lightbox" name="sc_lightbox">
			<option value="false">false</option>
			<option value="true">true</option>
		</select>
	</fieldset>
	<fieldset>
		<legend>Enable Lightbox Titles</legend>
		<select id="sc_lightboxtitles" name="sc_lightboxtitles">
			<option value="false">false</option>
			<option value="true">true</option>
		</select>
	</fieldset>
	<fieldset>
		<legend>Enable Slideshow Titles</legend>
		<select id="sc_titles" name="sc_titles">
			<option value="false">false</option>
			<option value="true">true</option>
		</select>
	</fieldset>
	<fieldset>
	<legend>Populate Slideshow from another page</legend>
	<p>Enter Page ID ( Leave Blank for Current Page )</p>
	<input id="slideshow_page" name="slideshow_page" type="text" style="width:145px">
	</fieldset>
