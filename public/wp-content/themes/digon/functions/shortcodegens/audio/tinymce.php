<?php
class add_mtheme_audio {
	
	var $pluginname = 'mtheme_audio';
	var $path = '';
	var $internalVersion = 100;
	
	function add_mtheme_audio()  {
		
		// Set path to editor_plugin.js
		$this->path = get_template_directory_uri() . '/functions/shortcodegens/audio/';	
	...
	function add_tinymce_langs_path($plugin_array) {
		...
		$plugin_array[$this->pluginname] = get_template_directory_uri() . '/functions/shortcodegens/audio/langs.php';
		return $plugin_array;
	}
...
$tinymce_button = new add_mtheme_audio ();
