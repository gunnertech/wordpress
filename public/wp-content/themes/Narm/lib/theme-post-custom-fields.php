...
$postmetas = 
	array (
		...
		*/
		array("section" => "Homepage Boxes", "id" => "home_box_icon_url", "title" => "Box icon URL <strong>*Recommend size width 50 pixels and height 50 pixels</strong>:"),
		/*
		...
		*/
		array("section" => "Content Attributes", "id" => "gallery_type", "type" => "select", "title" => "Select content type (image, vimeo video or youtube video)", "items" => array("Image", "Vimeo Video", "Youtube Video")),
		array("section" => "Content Attributes", "id" => "gallery_image_url", "title" => "Image URL:"),
		
		array("section" => "Content Attributes", "id" => "gallery_vimeo_id", "title" => "Vimeo video ID:"),
		array("section" => "Content Attributes", "id" => "gallery_youtube_id", "title" => "Youtube video ID:"),
		array("section" => "Content Attributes", "id" => "content_align", "type" => "select", "title" => "Content alignment (for homepage slider)", "items" => array("Left", "Right")),
		/*
...
function create_meta_box() {
	...
	if ( function_exists('add_meta_box') && isset($postmetas) && count($postmetas) > 0 ) {  
		add_meta_box( 'metabox', 'Narm Post Information', 'new_meta_box', 'post', 'normal', 'high' );  
	}
