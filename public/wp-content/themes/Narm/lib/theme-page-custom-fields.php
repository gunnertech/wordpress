...
$theme_sidebar = array('-- Select sidebar --','Page Sidebar', 'Contact Sidebar', 'Blog Sidebar');
...
$page_postmetas = 
	array (
		...
		*/
		...
		array("section" => "Page Short Description", "id" => "page_description", "type" => "text", "title" => "Enter a short desciption, this will display below page title"),
		/*
...
function page_create_meta_box() {
	...
	if ( function_exists('add_meta_box') && isset($page_postmetas) && count($page_postmetas) > 0 ) {  
		add_meta_box( 'page_metabox', 'Narm Page Options', 'page_new_meta_box', 'page', 'normal', 'high' );  
	}
