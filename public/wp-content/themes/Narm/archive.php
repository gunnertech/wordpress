...
//if display normal category blog posts
...
?>
		...
		<div id="content_wrapper">
			...
			<div class="<?php echo $caption_class?>">
				...
				<?php printf( __( 'Archives / %s', 'narm' ), get_the_date() ); ?>
<?php elseif ( is_month() ) : ?>
				<?php printf( __( 'Archives / %s', 'narm' ), get_the_date('F Y') ); ?>
<?php elseif ( is_year() ) : ?>
				<?php printf( __( 'Archives / %s', 'narm' ), get_the_date('Y') ); ?>
<?php else : ?>
				<?php _e( 'Blog Archives', 'narm' ); ?>
<?php endif; ?></h1>
...
?>
						...
						<div class="post_wrapper">
							...
							<div class="post_img">
								<img src="<?php echo get_image_path($image_thumb); ?>?h=200&w=590&zc=1" alt="" class="frame" />
