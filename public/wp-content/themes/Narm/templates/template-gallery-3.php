						...
						?>
											...
											<?php
												...
												foreach($gallery_items as $key => $gallery_item)
												{
													...
													$image_url = get_post_meta($gallery_item->ID, 'blog_thumb_image_url', true);
															...
															<div class="one_third<?php echo $last_class?>">
																<div class="gallery_image">
																	<a href="<?php echo $image_url?>" class="portfolio_image">
																		<img style="height:182px; width:250px;" src="<?php echo get_image_path($image_url); ?>" alt="" class="frame"/>
																	</a>
