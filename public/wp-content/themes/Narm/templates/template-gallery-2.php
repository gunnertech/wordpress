															...
															<div class="one_half<?php echo $last_class?>">
																<div class="gallery_image">
																	<a href="<?php echo $image_url?>" class="portfolio_image">
																		<img style="height:290px; width:400px;" src="<?php echo get_image_path($image_url); ?>" alt="" class="frame"/>
																	</a>
													    	...
													    	<div class="one_half<?php echo $last_class?>">
															    <div class="gallery_image">
																	<a href="#youtube_video<?php echo $key?>" class="portfolio_youtube">
																		<img src="<?php echo get_image_path($image_url); ?>" style="height:290px; width:400px;" alt="" class="frame"/>
																	</a>
