...
if($nm_portfolio_cat == $cat->parent OR $nm_portfolio_cat == $cat->cat_ID)
{
		...
		<div id="content_wrapper">
			...
			<div class="<?php echo $caption_class?>">
				<div class="caption_inner">
					<h1 class="cufon"><?php
						printf( __( 'Category / %s', 'narm' ), '' . single_cat_title( '', false ) . '' );
					?></h1>
...
?>
						...
						<div class="post_wrapper">
							...
							<div class="post_img">
								<img src="<?php echo get_image_path($image_thumb); ?>" style="height:200px; width:590px;" alt="" class="frame" />
