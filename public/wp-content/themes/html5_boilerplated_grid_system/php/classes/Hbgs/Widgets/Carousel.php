...
class Hbgs_Widgets_Carousel extends Hbgs_Widget {
  
  function __construct() {
  	$widget_ops = array( 'classname' => 'carousel-widget', 'description' => 'A widget that lets you build your own query and display items based on that.' );
  	$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'carousel-widget' );

  	parent::__construct( 'carousel-widget', 'Carousel Widget', $widget_ops, $control_ops );
  }
  ...
  function parent_update( $new_instance, $old_instance ) {
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['the_template'] = 'carousel.php';
  ...
  function print_default_styles() {
    wp_enqueue_style('carousel','/wp-content/themes/html5_boilerplated_grid_system/css/featuredCarousel.css');
  }
  
  function print_default_scripts() { 
    wp_enqueue_script( 'reflect', get_bloginfo('template_url').'/js/reflect.js', array('jquery'));
    wp_enqueue_script( 'pixastic', get_bloginfo('template_url').'/js/pixastic.js', array('jquery'));
    wp_enqueue_script( 'carousel', get_bloginfo('template_url').'/js/jquery.featuredCarousel.js', array('jquery'));
  }
