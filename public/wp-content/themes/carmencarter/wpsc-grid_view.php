...
<?php wpsc_output_breadcrumbs(); ?>
	...
	<?php if(wpsc_display_categories() && !$_GET['range']): ?>
			...
			<div class="wpsc_categories wpsc_category_grid group">
				<?php wpsc_start_category_query(array('category_group'=> 1, 'show_thumbnails'=> 1)); ?>
				  <div class="category-item">
  					...
  					<h3  style="width:<?php echo get_option('category_image_width') ?>px;" class="product-category-name"><a href="<?php wpsc_print_category_url();?>"><?php wpsc_print_category_name(); ?></a></h3>
	...
	<?php if(wpsc_is_in_category()) : ?>
		<div class="wpsc_category_details">
			<?php if(get_option('show_category_thumbnails') && wpsc_category_image()) : ?>
				...
				<h2 class="product-category-name"><?php echo wpsc_category_name(); ?></h2>
			<?php endif; ?>
