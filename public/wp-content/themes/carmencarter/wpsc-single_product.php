					...
					<div class="productcol">			
						...
						<div class="custom_meta">
							<?php while ( wpsc_have_custom_meta() ) : wpsc_the_custom_meta(); ?>
								<div class="product-meta"><strong class="<?php echo strtolower(preg_replace('/\W/','-',wpsc_custom_meta_name())) ?>"><?php echo wpsc_custom_meta_name(); ?> </strong><?php echo wpsc_custom_meta_value(); ?></div>
							<?php endwhile; ?>
							...
							<div class="wpsc_product_price">
								...
								<?php else : ?>
									<?php if(wpsc_product_on_special()) : ?>
										<p class="pricedisplay <?php echo wpsc_the_product_id(); ?>"><span class="label"><?php _e('Old Price', 'wpsc'); ?>:</span> <span class="oldprice" id="old_product_price_<?php echo wpsc_the_product_id(); ?>"><?php echo wpsc_product_normal_price(); ?></span></p>
									<?php endif; ?>
									<p class="pricedisplay <?php echo wpsc_the_product_id(); ?>"><span class="label"><?php _e('Price', 'wpsc'); ?>:</span> <span id='product_price_<?php echo wpsc_the_product_id(); ?>' class="currentprice pricedisplay"><?php echo wpsc_the_product_price(); ?></span></p>
									<?php if(wpsc_product_on_special()) : ?>
